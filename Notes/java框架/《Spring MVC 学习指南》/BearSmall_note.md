...
2. 附录D 部署描述符。Servlet3 之前，部署工作必然涉及部署描述符，即web.xml文件，但是Servlet3 之后，部署描述符是可选的。
...
# END & EVALUATES
>这本书从1月17日计划看到今天2月24日全部看完前前后后一共一个星期时间。和我预期的一样，因为初看这边书的时候感觉很基础，所以预计是一周看完。
>事实上这一周每天都在看，不过越到后面越感觉不对劲。虽然每天还是能看好几十页，但每天读得越来越快。原因很简单：内容不够充实，有些知识点有拼凑的嫌疑【我之前对SpringMVC有一定了解】。
>废话少说，下面是个人感觉本书的优点和缺点。

* 优点
    1. 书的封面很简洁漂亮。
    2. 全书300页不到的样子不用花大力气啃。
* 缺点
    1. 书上好多知识点太基础。
    2. 罗列式的知识点呈现。
    3. 书上掺杂了大量的非SpringMVC知识点【保守估计占全书内容的1/3以上，可怕】。
    4. 这本书内容写得也不怎么好【不知是原作的原因还是译者的问题，总之既不深入又不浅出】。
    5. 越读到后面越没耐心读了，因为越来越感觉营养价值不高。

>>**结束语：**

>>不推荐买这本书学习SpringMVC。如果只是要入门，可以看网上的博客，写得好的也很多。
>>或者看视频【网上搜或者上淘宝，几块钱就可以买到】。如果是想系统的学习SpringMVC建议看官网的文档，另外还有一本书叫
>>《Spring in Action》里面也有介绍SpringMVC的部分，这本书我最近正在读，到时候读完了视情况再推荐。
